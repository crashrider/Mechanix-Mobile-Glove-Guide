...
MAKE_SYSTEM_PROP(ACTIVITY,UIMechanixMobileGloveGuideNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UIMechanixMobileGloveGuideNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UIMechanixMobileGloveGuideNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UIMechanixMobileGloveGuideNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UIMechanixMobileGloveGuideNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UIMechanixMobileGloveGuideNativeItemContactAdd);
