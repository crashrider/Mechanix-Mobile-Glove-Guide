...
//@interface MechanixMobileGloveGuideObject : NSObject
//@end

@interface MechanixMobileGloveGuideObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[MechanixMobileGloveGuideObject class]])
		{
			for (NSString *key in [[(MechanixMobileGloveGuideObject*)o modules] allKeys])
			{
