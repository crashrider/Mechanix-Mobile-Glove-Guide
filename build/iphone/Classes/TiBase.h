...
// in simulator we redefine to format for MechanixMobileGloveGuide Developer console
...
{\
	NSString * exceptionName = [@"org.mechanixmobilegloveguide." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.mechanixmobilegloveguide";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIMechanixMobileGloveGuideNativeItemNone = -1, 
	UIMechanixMobileGloveGuideNativeItemSpinner = -2,
	UIMechanixMobileGloveGuideNativeItemProgressBar = -3,
	
	UIMechanixMobileGloveGuideNativeItemSlider = -4,
	UIMechanixMobileGloveGuideNativeItemSwitch = -5,
	UIMechanixMobileGloveGuideNativeItemMultiButton = -6,
	UIMechanixMobileGloveGuideNativeItemSegmented = -7,
	
	UIMechanixMobileGloveGuideNativeItemTextView = -8,
	UIMechanixMobileGloveGuideNativeItemTextField = -9,
	UIMechanixMobileGloveGuideNativeItemSearchBar = -10,
	
	UIMechanixMobileGloveGuideNativeItemPicker = -11,
	UIMechanixMobileGloveGuideNativeItemDatePicker = -12,
	
	UIMechanixMobileGloveGuideNativeItemInfoLight = -13,
	UIMechanixMobileGloveGuideNativeItemInfoDark = -14,
	
	UIMechanixMobileGloveGuideNativeItemDisclosure = -15,
	
	UIMechanixMobileGloveGuideNativeItemContactAdd = -16
};
